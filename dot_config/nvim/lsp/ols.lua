...
local function default_odin_root()
  ...
  if odin_root ~= nil and odin_root ~= '' then return vim.fs.normalize(odin_root) end

  -- https://github.com/odin-lang/Odin/wiki/Compiler-Flags
  if vim.fn.executable 'odin' == 0 then return end
...
local function is_library(fname)
  ...
  if odin_root == nil then return nil end
